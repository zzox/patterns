export const challenges = [
  ...
  { name: 'Roller', pattern: [1, 2, 1, 3, 1, 4, 1, 3], repetitions: 8, limit: 20000 },
  { name: 'Split-Tap', pattern: [1, 2], repetitions: 2, limit: 250 },
  { name: 'All Up 2', pattern: [1, 2, 3, 4], repetitions: 8, limit: 10000 },
  { name: 'Ten-Tap 2', pattern: [1], repetitions: 10, limit: 5000 },
  { name: 'Roller 2', pattern: [1, 2, 1, 3, 1, 4, 1, 3], repetitions: 8, limit: 10000 },
  ...
  { name: 'Roller 3', pattern: [1, 2, 1, 3, 1, 4, 1, 3], repetitions: 8, limit: 8000 },
